...
st.set_page_config(
    ...
    menu_items={
        'Get help': 'https://github.com/bikiCoder23',
...
st.caption('This Dashboard is part of the "4th year B. Tech Major project" at the Indian Institute of Engineering Science & Technology. This tool is not sufficient to use for medical diagnosis. Please consult a doctor for a professional opinion. We do not take any responsibility for any decision made based on the output of this tool and the use of this tool is just for educational purposes.')
...
with LEFT:
    ...
    with left:
        age = st.selectbox('Age', df['Age'].unique(), index=None, help='Age of the patient. Young: less or equal to 54 | Old: more than 55 years old.')
    with mid:
        sex = st.selectbox('Sex', df['Sex'].unique(), index=None, help="The gender of the patient.")
...
with st.expander('Credits & Authors'):
    st.caption(
        'Bikramjit Saha, Deep Modak and Sandip Mondal @ 2024 - Indian Institute of Engineering Science & Technology, Shibpur')